# HexRandomizationSourceExtensions.HashSha512 method

Gets a pseudo-random hexadecimal string (`0` through `f`, lowercase, via [`Hexadecimal`](./Hexadecimal.md)) having a length matching a hash generated by SHA-512, `128` characters.
