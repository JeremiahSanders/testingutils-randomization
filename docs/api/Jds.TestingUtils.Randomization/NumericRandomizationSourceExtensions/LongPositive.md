# NumericRandomizationSourceExtensions.LongPositive method

Gets a pseudo-random Int64, using [`NextLongInRange`](../IRandomizationSource/NextLongInRange.md). The value should be greater than or equal to 0, and less than MaxValue.
...
An Int64 greater than or equal to 0, and less than MaxValue.
